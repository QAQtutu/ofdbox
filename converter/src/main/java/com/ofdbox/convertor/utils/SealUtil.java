...
public abstract class SealUtil {
     ...
     * 
     * @param dpi
     * @param mainText 印章上方的弧形文字
     * @param viceText 印章下方的弧形文字
     * @param centerText 印章中间的文字
     * @return 印章图片对象
     * @throws Exception
     */
    public static BufferedImage buildInvoiceSeal(int dpi, String mainText, String viceText, String centerText)
                    throws Exception {
        dpi = dpi * 2;
        /**
         * 印章配置文件
        ...
        viceFont.setFontFamily("楷体");
        viceFont.setMarginSize(5);
        viceFont.setFontText(viceText);
        viceFont.setFontSize(fontSize);
        viceFont.setFontSpace(13.0);
        /**
         * 添加副文字
         */
        ...
        centerFont.setFontFamily("楷体");
        centerFont.setFontText(centerText);
        centerFont.setFontSize((int) (fontSize * 0.9));
        /**
         * 添加中心文字
         */
         ...
         * 图片大小
         */
        configuration.setImageSize((int) (dpi * 15.5));
        /**
         * 背景颜色
         */
         ...
         * 边线粗细、半径
         */
        // configuration.setBorderCircle(new SealCircle(8, 140, 100));
        // configuration.setBorderCircle(new SealCircle((int) (0.4 * dpi), 7 * dpi, 5 * dpi));
        configuration.setBorderCircle(new SealCircle((int) (0.4 * dpi), (int) (7.5 * dpi), 5 * dpi));
        /**
         * 内边线粗细、半径
         */
        // configuration.setBorderInnerCircle(new SealCircle(2, 130, 90));
        // configuration.setBorderInnerCircle(new SealCircle((int) (0.1 * dpi), (int) (6.5 * dpi), (int)
        // (4.5 * dpi)));
        configuration.setBorderInnerCircle(new SealCircle((int) (0.1 * dpi), 7 * dpi, (int) (4.66 * dpi)));
